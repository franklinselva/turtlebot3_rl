...
class Env():
    def __init__(self, action_size):
        '''
        Initializes the gazebo environment as RL environment
        '''
    ...
    def getGoalDistace(self):
        ...
        Gets goal distance for the current iteration
        '''
    ...
    def getOdometry(self, odom):
        '''
        Get odometry value for the robot

        Calculation made for base position and goal position
        '''
